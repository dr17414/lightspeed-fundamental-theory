...
| 4 | E1 joint contrast | `STAGE5C_6A_E_STATISTICAL_REGIONS.md`＋paired estimand／2D cluster-$t$ rectangle／joint floor／item-3 numerical uncertainty propagation／strict boundary rules | `REVIEW-PENDING` |
