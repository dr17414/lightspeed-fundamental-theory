...
| 4 | E1 joint contrast | `STAGE5C_6A_E_STATISTICAL_REGIONS.md`＋paired estimand／2D cluster-$t$ rectangle／joint floor／typed CLEAN item-3 provenance／exact-dyadic outward uncertainty propagation／strict boundary rules | `REVIEW-PENDING` |
