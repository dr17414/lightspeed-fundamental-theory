...
| 8 | E5-D／E5-E multiplicity與 power | complete claim family＋lineage-wide spending／successor reserve＋power audit；numerical cap 的 producer-bound feasibility、certification-success probability 與 conditioned matched-null law 須在不讀 arm data 下交付，不能把 conditional CLEAN power 當作完整 split power | `OPEN` |
