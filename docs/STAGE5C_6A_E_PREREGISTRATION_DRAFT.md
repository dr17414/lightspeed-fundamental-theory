...
| 4 | E1 joint contrast | `STAGE5C_6A_E_STATISTICAL_REGIONS.md`＋paired estimand／2D cluster-$t$ rectangle／joint floor／producer-sealed CLEAN item-3 provenance／aggregation-only numerical width／exact-dyadic outward uncertainty propagation／strict normalized boundary rules | `REVIEW-PENDING` |
