...
| **Stage 5C acceptance specification** | **【草案／尚未開始】** | C0–C11 驗收規格草案與六項已評估之替代 primitive 已保存於 handoff v2.0，供下一階段獨立審查。它們尚未通過漏洞、循環驗證、primitive ledger 與驗收充分性檢查；不得視為已接受規格，亦不得由其中的「待評估候選材料」提前設計 kernel $K$。 | `docs/handoff_v2.0.md` |
